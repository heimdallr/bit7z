...
const GUID IID_IStreamSetRestriction = {
    0x23170F69, 0x40C1, 0x278A, { 0x00, 0x00, 0x00, 0x03, 0x00, 0x10, 0x00, 0x00 }
};
...
const GUID IID_IArchiveExtractCallbackMessage2 = {
    0x23170F69, 0x40C1, 0x278A, { 0x00, 0x00, 0x00, 0x06, 0x00, 0x22, 0x00, 0x00 }
};
